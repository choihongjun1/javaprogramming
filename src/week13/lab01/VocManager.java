...
public class VocManager {
    ...
    public void menu() {
        ...
        while (choice != 2) {
            try {
                System.out.print("1)단어검색 2)종료 3)부분검색 4)빈출단어 > ");
    ...
    private void menu04() {
        Stream<Word> listStream = voc.stream();
        listStream.sorted((o1, o2) -> ((o1.count - o2.count) * -1))
                .filter(o -> o.count > 0).limit(5)
                .forEach(o -> System.out.println(o.count + "번 ->" + o));
    }
